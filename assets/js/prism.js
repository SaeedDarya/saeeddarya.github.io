/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+css-extras+dart+git+java+json+json5+jsonp+powershell+python+jsx+tsx+sql+typescript+visual-basic+yaml&plugins=command-line+toolbar+copy-to-clipboard+download-button */
var _self =
